...
abstract class ALayout<A extends ALayout, V extends View> extends ViewGroup implements ILayout<A, V> {
    protected Background background;
    protected Resources res;

    public ALayout(@NonNull Context c) {
        this(c, null);
    }

    public ALayout(@NonNull Context c, @Nullable AttributeSet attrs) {
        this(c, attrs, 0);
    }

    public ALayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    public V findChildById(@IdRes int id) {
